 ...
 * (Layout of the nodes; variant)       *
 *                                      *
 * An alternative of location.cc, which *
 * spreads the nodes of the top level   *
 * and the leaves over the full width.  *
 * Build either this file or            *
 * location.cc, never both of them.     *
 ****************************************/
